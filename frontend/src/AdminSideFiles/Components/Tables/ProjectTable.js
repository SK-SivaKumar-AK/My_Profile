        ...
        <tbody>
            ...
            projectData.map((item , index) => {
                return (
                    ...
                    <td className='text-center'><img src={`${process.env.REACT_APP_BASE_URL}/assets/uploads/images/${item.projectImage}`} alt={item.projectImage} width={'50px'} height={'50px'} /></td>
